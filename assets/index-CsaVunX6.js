...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsx("div",{className:"CommentInfo__name",children:e.name}),O.jsx("div",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email}),O.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Lc=({comments:e})=>O.jsx(O.Fragment,{children:e.map(t=>O.jsx(Pc,{comment:t},t.id))}),Mc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Tc=({post:e,comments:t,user:i})=>O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:e.title}),O.jsxs("p",{children:["Posted by",O.jsx(Mc,{user:i})]})]}),O.jsx("p",{className:"PostInfo__body",children:e.body}),O.jsx("hr",{}),t?O.jsx(Lc,{comments:t}):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsx(Tc,{post:t,comments:t.comments,user:t.users},t.id))}),Dc=()=>{const e=zc.reduce((n,a)=>({...n,[a.postId]:[...n[a.postId]||[],a]}),{}),t=Nc.reduce((n,a)=>({...n,[a.id]:a}),{}),i=Cc.map(n=>({...n,users:t[n.userId],comments:e[n.id]}));return O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Rc,{posts:i})]})};em(document.getElementById("root")).render(O.jsx(Dc,{}));
